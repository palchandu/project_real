...
<title>SKGP </title>
<link rel="shortcut icon" href="<?php global $skgp_options; echo $skgp_options['site_favicon']['url']; ?>">
<!--[if lt IE 9]>
    ...
    <div class="top-search">
        ...
        <form role="search" method="get" class="search-form" action="<?php echo esc_url( home_url( '/' ) ); ?>">
            <div class="input-group">
                ...
                <input type="search" id="<?php echo $unique_id; ?>" class="form-control" placeholder="<?php echo esc_attr_x( 'Search &hellip;', 'placeholder', 'getwebsoftware' ); ?>" value="<?php echo get_search_query(); ?>" name="s" title="Search for:">
