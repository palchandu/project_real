...
function skgp_theme_init()
{
	...
	add_image_size('recent_post',82,79,true);
	add_image_size('about_slider',570,349,true);
...
/*************************************************************************************************/
/******************************ADDING CUSTOM META BOXES*******************************************/
include('include/property_google_map.php');
/*************************************************************************************************/
/*************************************************************************************************/


/*************************************************************************************************/
/******************************ADDING PROPERTY CUSTOM META BOXES TWO******************************/
include('include/property_metabox_two.php');
/*************************************************************************************************/
/*************************************************************************************************/

/*************************************************************************************************/
/******************************ADDING PROPERTY CUSTOM META BOXES TWO******************************/
include('include/property_videos.php');
/*************************************************************************************************/
/*************************************************************************************************/
...
include('include/contact_meta.php');
/*************************************************************************************************/
/*************************************************************************************************/
...
/**************************************************************************************************/
/********************************REDUX FRAMEWORK***************************************************/
require_once('include/redux-framework-master/redux-framework.php');
require_once('include/skgp-master-theme-option.php');
/**************************************************************************************************/
/********************************REDUX FRAMEWORK***************************************************/
...
function hide_editor() {
	...
	if($template_file == 'contact.php'){ // template
